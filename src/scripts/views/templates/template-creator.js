...
<article class="restaurant-item" onclick="location.href='#/detail/${restaurant.id}'" style="cursor: pointer;">
    <div class="thumbnail">
        <img class="lazyload" class="restaurant-item__thumbnail" data-src="${restaurant.pictureId ? CONFIG.BASE_IMAGE_URL.MEDIUM + restaurant.pictureId : 'https://picsum.photos/id/666/800/450?grayscale'}" alt="${restaurant.name}">
    ...
    <div class="restaurant-item__content">
        ...
        <h3 class="restaurant-item__title restaurant__title"><a href="#/detail/${restaurant.id}">${restaurant.name || '-'}</a></h3>
        <p class="restaurant-item__description" maxLength="5">${restaurant.description || '-'}</p>
    </div>
</article>
`;
